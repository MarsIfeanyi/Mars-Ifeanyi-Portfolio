...
const SkillCard = ({ icon: Icon, name }: Props) => {
  return (
    <div className="group relative bg-white dark:bg-gray-900 dark:border-white dark:border shadow-md rounded-xl p-4 flex flex-col items-center gap-3 cursor-pointer hover:scale-105 transition-all duration-300">
